...
> TL;DR: AI Optimisation — quick summary of value and when to use it.
...
## What it is
Briefly define ai optimisation and when it applies.
...
## Conclusion
Summarize when to use ai optimisation and next steps.
