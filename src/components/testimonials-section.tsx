  ...
  return (
    <div className="w-full border-b border-border/40 flex flex-col justify-center items-center">
          ...
          <Badge
            icon={
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6 1L7.5 4.5L11 4.5L8.5 7L9.5 10.5L6 8.5L2.5 10.5L3.5 7L1 4.5L4.5 4.5L6 1Z" stroke="currentColor" strokeWidth="1" fill="none" />
              </svg>
            }
            text="Testimonials"
          />
      ...
      <div className="self-stretch flex justify-center items-start">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-0 border-l border-r border-border/40">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className={`border-b border-r-0 md:border-r border-border/40 p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6 ${
