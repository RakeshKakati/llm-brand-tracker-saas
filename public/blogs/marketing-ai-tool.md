...
> TL;DR: Marketing AI Tool — quick summary of value and when to use it.
...
## What it is
Briefly define marketing ai tool and when it applies.
...
## Conclusion
Summarize when to use marketing ai tool and next steps.
