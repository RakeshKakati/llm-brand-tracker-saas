...
> TL;DR: AI for Analytics — quick summary of value and when to use it.
...
## What it is
Briefly define ai for analytics and when it applies.
...
## Conclusion
Summarize when to use ai for analytics and next steps.
