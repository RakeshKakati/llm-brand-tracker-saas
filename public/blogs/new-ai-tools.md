...
> TL;DR: New AI Tools — quick summary of value and when to use it.
...
## What it is
Briefly define new ai tools and when it applies.
...
## Conclusion
Summarize when to use new ai tools and next steps.
