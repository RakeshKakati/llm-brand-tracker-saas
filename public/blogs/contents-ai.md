...
> TL;DR: Contents AI — quick summary of value and when to use it.
...
## What it is
Briefly define contents ai and when it applies.
...
## Conclusion
Summarize when to use contents ai and next steps.
