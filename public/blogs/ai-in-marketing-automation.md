...
> TL;DR: AI in Marketing Automation — quick summary of value and when to use it.
...
## What it is
Briefly define ai in marketing automation and when it applies.
...
## Conclusion
Summarize when to use ai in marketing automation and next steps.
