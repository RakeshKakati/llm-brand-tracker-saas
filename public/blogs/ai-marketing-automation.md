...
> TL;DR: AI Marketing Automation — quick summary of value and when to use it.
...
## What it is
Briefly define ai marketing automation and when it applies.
...
## Conclusion
Summarize when to use ai marketing automation and next steps.
