...
> TL;DR: AI and Sales — quick summary of value and when to use it.
...
## What it is
Briefly define ai and sales and when it applies.
...
## Conclusion
Summarize when to use ai and sales and next steps.
