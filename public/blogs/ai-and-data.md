...
> TL;DR: AI and Data — quick summary of value and when to use it.
...
## What it is
Briefly define ai and data and when it applies.
...
## Conclusion
Summarize when to use ai and data and next steps.
