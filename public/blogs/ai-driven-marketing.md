...
> TL;DR: AI Driven Marketing — quick summary of value and when to use it.
...
## What it is
Briefly define ai driven marketing and when it applies.
...
## Conclusion
Summarize when to use ai driven marketing and next steps.
