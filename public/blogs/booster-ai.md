...
> TL;DR: Booster AI — quick summary of value and when to use it.
...
## What it is
Briefly define booster ai and when it applies.
...
## Conclusion
Summarize when to use booster ai and next steps.
