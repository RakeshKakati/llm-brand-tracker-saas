...
> TL;DR: Get Answer — quick summary of value and when to use it.
...
## What it is
Briefly define get answer and when it applies.
...
## Conclusion
Summarize when to use get answer and next steps.
