...
> TL;DR: Insider AI — quick summary of value and when to use it.
...
## What it is
Briefly define insider ai and when it applies.
...
## Conclusion
Summarize when to use insider ai and next steps.
