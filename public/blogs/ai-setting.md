...
> TL;DR: AI Setting — quick summary of value and when to use it.
...
## What it is
Briefly define ai setting and when it applies.
...
## Conclusion
Summarize when to use ai setting and next steps.
