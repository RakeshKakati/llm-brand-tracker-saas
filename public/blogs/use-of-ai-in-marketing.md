...
> TL;DR: Use of AI in Marketing — quick summary of value and when to use it.
...
## What it is
Briefly define use of ai in marketing and when it applies.
...
## Conclusion
Summarize when to use use of ai in marketing and next steps.
